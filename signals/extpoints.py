...
Конкретные точки расширения приложения. Это и есть то самое «одно место», через
которое добавляется новая фича — какой бы она ни была. Внутренности программы
знать не нужно, достаточно зарегистрироваться в подходящем реестре:
