...
любой вид плагинов — приборы, вычисляемые колонки, функции выражений, парсеры,
экспортёры. Добавить фичу — значит зарегистрировать её в подходящем реестре
одной строкой: декоратором при импорте модуля или прямо в рантайме (так
делают пользовательские колонки и формулы, которые вводят через GUI).
